...
class KYKSKN:
    ...
    def scan_networks(self) -> bool:
        ...
        # Start scan - 30 SANİYE!
        console.print(f"[yellow]⏳ 30 saniye tarama başlatılıyor...[/yellow]")
        success = self.network_scanner.start_scan(duration=30)
